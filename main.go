...
// Define the customer structure, with 6 properties.  Structure tags are used by encoding/json library
...
func (s *SmartContract) createCustomer(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var customer = Customer{Name: args[1], Age: args[2], Gender: args[3], PAN: args[4], AccountNumber: args[5], MailID: args[6]}
